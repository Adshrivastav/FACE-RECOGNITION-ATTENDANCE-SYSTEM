...
class Ui_OutputDialog(QDialog):
	def __init__(self):
		...
		self.logic=0
		self.value=1
		# Update Time and Date and capture image
				...
				with open('Attendance.csv', 'a') as f:
					if (name != 'unknown'):
						...
						if buttonReply == QMessageBox.Yes:
							...
							self.Hours_Label.setText("{:0f}".format(abs(self.ElapseHours.total_seconds() / 60)))
							self.Min_Label.setText("{:0f}".format(abs(self.ElapseHours.total_seconds() / 60)))
